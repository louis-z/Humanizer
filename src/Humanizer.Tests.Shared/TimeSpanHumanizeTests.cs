...
namespace Humanizer.Tests
{
    ...
    public class TimeSpanHumanizeTests
    {
        ...
        [Theory]
        [InlineData(4, "4 days old")]
        [InlineData(23, "3 weeks old")]
        [InlineData(64, "2 months old")]
        [InlineData(367, "1 year old")]
        [InlineData(750, "2 years old")]
        ...
        [Theory]
        [InlineData(4, "4-day-old")]
        [InlineData(23, "3-week-old")]
        [InlineData(64, "2-month-old")]
        [InlineData(367, "1-year-old")]
        [InlineData(750, "2-year-old")]
